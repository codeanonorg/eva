...
<<<<<<< HEAD
Le langage assembleur constitue la premiÃ¨re abstraction Ã  la programmation
de circuits programmables. Cela rend l'assembleur facile Ã  apprendre
et manipuler, mais difficile Ã  utiliser et maÃ®triser. Face Ã  l'Ã©tat
des choses, nous avons dÃ©cidÃ© de dÃ©velopper \noun{Eva}.

\noun{Eva} est une machine virtuelle dÃ©veloppÃ©e par des Ã©tudiants pour les
Ã©tudiants. Simple et lÃ©gÃ¨re, elle offre un terrain d'expÃ©rimentation
particuliÃ¨rement adaptÃ© Ã  l'apprentissage de l'assembleur ou encore
Ã  l'Ã©criture de compilateurs. Son code source publique, clair et documentÃ©
la rendent accessible et facilement modifiable. \noun{Eva} est programmable
dans un langage assembleur dÃ©diÃ© facile d'accÃ¨s et dotÃ© d'un jeu d'instructions
succinct mais complet. Par ailleurs, l'implÃ©mentation d'\noun{Eva} ainsi
=======
...
\hline 
<<<<<<< HEAD
\textbf{MOV} & Ã‰criture de valeur dans le registre\tabularnewline
=======
